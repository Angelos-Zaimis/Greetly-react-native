...
export const AUTH_TOKEN_ENDPOINT = 'auth/login'
export const AUTH_TOKEN_REFRESH_ENDPOINT = 'auth/token/refresh'
...
export const AUTH_TOKEN_VERIFY_ENDPOINT = 'auth/token/verify'
